    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item {{ $act == 'Dashboard' ? 'active' : '' }}">
                ...
                <li class="nav-item {{ $act == 'Penyakit' ? 'active' : '' }}">
                ...
                <li class="nav-item {{ $act == 'Gejala' ? 'active' : '' }}">
                ...
                <li class="nav-item {{ $act == 'Relasi' ? 'active' : '' }}">
                ...
                <li class="nav-item {{ $act == 'Diagnosa' ? 'active' : '' }}">
